    ...
    <>
      ...
      <div className="grid grid-cols-1 items-start gap-6 lg:grid-cols-3">
        <div className="flex flex-col gap-6 lg:col-span-2">
          ...
          {lastReset && (
            <div className="rounded-xl border border-emerald-500/30 bg-emerald-50 p-6 dark:bg-emerald-950/30">
              ...
              <p className="mt-4 border-t border-emerald-500/20 pt-4 text-sm text-muted-foreground">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="rounded-xl border border-amber-500/30 bg-amber-50 p-6 dark:bg-amber-950/20">
