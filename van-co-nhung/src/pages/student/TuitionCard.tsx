  ...
  const header = (
    <div className="flex flex-wrap items-center justify-between gap-2">
      ...
      <div className="flex items-center gap-2">
        <Badge variant={status === "PAID" ? "success" : status === "PENDING" ? "warning" : "neutral"}>
      ...
      {showDetails && (
        <>
          ...
          {status === "PAID" ? (
            ...
            <p className="rounded-lg border border-dashed border-status-warning/30 bg-status-warning-bg p-4 text-sm text-status-warning-fg">
